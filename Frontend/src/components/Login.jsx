...
import {LogIn,ArrowLeft, Mail, Lock, EyeOff, Eye} from 'lucide-react';
...
function Login({onLoginSuccess = null}) {
   ...
   const API_BASE = import.meta.env.VITE_API_BASE_URL || "http://localhost:4000";
    ...
    const handleSubmit = async (ev) => {
        ...
        if(!resp.ok){
            const msg = data ? data.message || "Login Failed" : "Login Failed";
            setSubmitError(msg);
            return;
        }
        if (data?.token) {
            ...
            <form onSubmit={handleSubmit} className={loginStyles.form} noValidate>
                <div className={loginStyles.formWrapper}>
                    <div className={loginStyles.animatedBorder}>
                        ...
                        <p className={loginStyles.subtitle}>Sign in to continue Quiz Maniac Society</p>
                        ...
                        <label className={loginStyles.label}>
                            ...
                            <div className={loginStyles.inputContainer}>
                                ...
                                <input type={showPassword ? "text" : "password"} name='password' value = {password} onChange={
                                    (e)=>{
